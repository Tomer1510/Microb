...
public interface AppConstants {
	...
	public final String CREATE_MESSAGES_TABLE = "CREATE TABLE Messages(ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),"
			...
			+ "PRIMARY KEY (ID))";
	public final String INSERT_MESSAGE_STMT = "INSERT INTO Messages(AuthorNickname, Content, Topics) VALUES(?,?,?)";
	...
	public final String SEARCH_MESSAGE_BY_TOPIC = "SELECT * FROM Messages WHERE Topics LIKE '%%\"%s\"%%' ORDER BY Timestamp DESC";
