...
function addMessage(message, div) {
	...
	var newMsg = '<div class = "col-md-12 panel panel-default message" data-id="'+message.messageID+'">'
		+'<div class="panel-body"><div class="panel-header"><div><a href="profile.html?nickname='+message.authorNickname+'" class=\"author\">@'+message.authorNickname+'</a></div><div>'+message.timestamp+'</div></div><hr>'
