...
public interface AppConstants {
	...
	public final String CREATE_MESSAGES_TABLE = "CREATE TABLE Messages(ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),"
			...
			+ "RepublishCounter INT(10000000) DEFAULT 0,"
			+ "PRIMARY KEY (ID))";
	...
	public final String SELECT_ALL_MESSAGES_OF_NICKNAME_STMT = "SELECT * FROM Messages WHERE AuthorNickname!=? ORDER BY LOG(2+(SELECT COUNT(*) FROM Following WHERE FollowingNickname = ?))*LOG(2+RepublishCounter) DESC";
